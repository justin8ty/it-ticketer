...
def _ensure_missing_columns(conn) -> None:
    ...
    _add_column(conn, "attachment", "attachment_description", "TEXT NULL")
    ...
    _add_column(conn, "closure_confirmation", "confirmed_at", "DATETIME NULL")
    _add_column(conn, "closure_confirmation", "rejected_at", "DATETIME NULL")
    _add_column(conn, "closure_confirmation", "rejection_reason", "TEXT NULL")
